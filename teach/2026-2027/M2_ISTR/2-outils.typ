...
#laas-slide(title: "Clavier", alignment: center)[
  #image(height: 10cm, "../../../media/ergol.png")
...
#laas-slide(title: "etc")[
  - pre-commit → prek
  - bash → fish-shell / nushell
  - screen / tmux → zellij
  - vim → helix
  - ls → eza
  - cat → bat
...
#section-slide("GenAI / LLM")

#laas-slide(title: "IA Générative")[
  - Détruit la planète
  - Détruit l’économie
  - Détruit la société
  - Détruit le cerveau de ses utilisateurs
  - Détruit les communautés open-source
  - TP: "Trick me"
]

#section-slide("Le reste")
